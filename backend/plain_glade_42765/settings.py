"""
Django settings for plain_glade_42765 project.
...
ROOT_URLCONF = 'plain_glade_42765.urls'
...
WSGI_APPLICATION = 'plain_glade_42765.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "plain_glade_42765 API",
    "DESCRIPTION": "API documentation for plain_glade_42765 App",
    "VERSION": "v1",
}
